...
func (r *RepositoryManager) Upload(c *gin.Context) {
	...
	if err != nil {
		app.Logger.Error("----------------1.5----" + err.Error())
	...
	if err != nil {
		app.Logger.Error(fullPath + "----------------2----" + err.Error())
	...
	if err == nil {
		app.Logger.Error(fullPath + "----------------3----" + err.Error())
	...
	if err != nil {
		app.Logger.Error(fullPath + "----------------4----" + err.Error())
